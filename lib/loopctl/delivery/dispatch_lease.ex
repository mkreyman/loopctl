defmodule Loopctl.Delivery.DispatchLease do
  ...
  a STOP bound: a runner on contract 1.19.0 ends the session by the earlier of its own start +
  ...
  (force-unclaim) ends the claim whenever it is made, by design, and a runner on an earlier contract ignores
